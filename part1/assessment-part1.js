...
// Tried to write my function as an arrow function but Jasmine did not like it so I had to revert back to a regular function.
// Vehicle = () => { this.gasRemaining = 100 };
...
function promiseCatcher(promise) {
  promise.then( response => {
    return ( this.theAnswer = response);
  });
}
